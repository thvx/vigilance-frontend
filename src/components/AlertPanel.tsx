...
export const AlertPanel = memo(function AlertPanel({
  ...
  /**
   * ✅ SOLO recalcula cuando cambia alerts
   */
...
const AlertCard = ({
  ...
  const severity =
    CRIME_TYPE_SEVERITY[alert.crime_type];

  const isEscalated =
    alert.validation_status === "confirmed";
